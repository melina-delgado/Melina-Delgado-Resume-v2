    ...
    {Jan 2022 - Present} % Date(s)
    {
        ...
        \begin{cvitems} % Description(s) of tasks/responsibilities
            ...
            \iftoggle{observability}{
                ...
                \item Leveraged \textbf{Kafka} for sending application service logs to data warehouses such as \textbf{Databricks} and \textbf{Elasticsearch} for further analysis and research
            }{}
            \iftoggle{cloud}{
